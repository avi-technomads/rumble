...
const Battle = () => {
  ...
  const liLists = [
    ...
    {
      id: 5,
      text: "95% of mint funds goes to prize  pool, 5% goes to team, marketing & gas fees",
    },

    {
      id: 6,
      text: "Mint revenue will be held in Escrow Wallet until full prize money is distributed",
    },
        ...
        <div className="container mx-auto py-24 ">
          ...
          <div className="grid md:grid-cols-2 place-items-center py-20">
            ...
            <div className="place-items-start">
              <ul className="text-white ul-list">
                {liLists.map((item) => (
