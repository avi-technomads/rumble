	...
	return (
		<div className='container mx-auto'>
			...
			<div className='grid md:grid-cols-2 gap-20'>
				{roadMap.map((i) => {
					return (
						<div className='bg-black px-14 py-16 w-fit text-white yello-shadow' key={i.id}>
							<div className='flex gap-1' data-aos='zoom-out'>
							...
							<p className='mt-10 font-medium text-xl' data-aos='zoom-out'>
